...
export default function PlayerAlt(props) {
  ...
  const front_1 = useLoader(THREE.TextureLoader, 'Sprites/plain_bear/front_1.png');
  const front_2 = useLoader(THREE.TextureLoader, 'Sprites/plain_bear/front_2.png');
  const front_3 = useLoader(THREE.TextureLoader, 'Sprites/plain_bear/front_3.png');
  const front_4 = useLoader(THREE.TextureLoader, 'Sprites/plain_bear/front_4.png');
  const left_1 = useLoader(THREE.TextureLoader, 'Sprites/plain_bear/left_1.png');
  const left_2 = useLoader(THREE.TextureLoader, 'Sprites/plain_bear/left_2.png');
  const left_3 = useLoader(THREE.TextureLoader, 'Sprites/plain_bear/left_3.png');
  const left_4 = useLoader(THREE.TextureLoader, 'Sprites/plain_bear/left_4.png');
  const right_1 = useLoader(THREE.TextureLoader, 'Sprites/plain_bear/right_1.png');
  const right_2 = useLoader(THREE.TextureLoader, 'Sprites/plain_bear/right_2.png');
  const right_3 = useLoader(THREE.TextureLoader, 'Sprites/plain_bear/right_3.png');
  const right_4 = useLoader(THREE.TextureLoader, 'Sprites/plain_bear/right_4.png');
  const back_1 = useLoader(THREE.TextureLoader, 'Sprites/plain_bear/back_1.png');
  const back_2 = useLoader(THREE.TextureLoader, 'Sprites/plain_bear/back_2.png');
  const back_3 = useLoader(THREE.TextureLoader, 'Sprites/plain_bear/back_3.png');
  const back_4 = useLoader(THREE.TextureLoader, 'Sprites/plain_bear/back_4.png');
      ...
      username: props.username
        ...
        window.addEventListener("keydown", function(e) {
          ...
          if (isMoving.current[38]) {
            changeSprite(currentSprite => updateSprite(currentSprite, 38))
            room.send("move", { y: 1 });
          }
          else if (isMoving.current[39]) {
            changeSprite(currentSprite => updateSprite(currentSprite, 39))
            room.send("move", { x: 1 });
          }
          else if (isMoving.current[40]) {
            changeSprite(currentSprite => updateSprite(currentSprite, 40))
            room.send("move", { y: -1 });
          }
          else if (isMoving.current[37]) {
            changeSprite(currentSprite => updateSprite(currentSprite, 37))
            room.send("move", { x: -1 });
          }
          ready.current = false;
  ...
  return (
    ...
    <mesh position={[players[key].x, players[key].y, 0]}>
      ...
      <meshBasicMaterial attach="material" map={currentSprite} toneMapped={false} transparent={true} />
      </mesh>
